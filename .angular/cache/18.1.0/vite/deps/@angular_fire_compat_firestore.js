...
import {
  ...
  where
} from "./chunk-5HFQJCRX.js";
import "./chunk-B3GVLIHS.js";
import {
  FirebaseApp
} from "./chunk-KPKZFSMB.js";
import {
  FIREBASE_APP_NAME,
  FIREBASE_OPTIONS,
  ɵapplyMixins,
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-TP7FXQ3S.js";
import "./chunk-6WVNURAY.js";
import {
  firebase
} from "./chunk-QI5EKTUH.js";
import {
  VERSION,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name3, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-W7OVFBTO.js"))), map(() => ɵfirebaseAppFactory(options, zone, name3)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
